"""
ResUNet3d — Residual 3D U-Net for BraTS2020.
Extracted from: MultiModel XAI Brats2020.ipynb (cell 46)

Uses: ResBlock (GroupNorm+ReLU+Conv3d + skip), MaxPool3d down, Trilinear up.
"""
...
class ResDown(nn.Module): # Move downwards
